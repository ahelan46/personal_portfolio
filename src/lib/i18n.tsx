...
export const DICT: Record<string, Entry> = {
  ...
  "hero.h1a": { en: "Hi, I'm a", fr: "Salut, je suis" },
  "hero.h1aEm": { en: " ", fr: " " },
  "hero.h1b": { en: " ", fr: " " },
  "hero.h1bEm": { en: "isn’t.", fr: "est pas." },
  "hero.sub": {
    en: "I build digital products end to end — architecture, backend, frontend, systems — with one obsession: writing clean, scalable, and efficient code.",
    fr: "Je construis des produits numériques de bout en bout — architecture, backend, frontend, systèmes — avec une obsession : écrire un code propre, évolutif et efficace.",
  },
  "hero.cta1": { en: "View My Work", fr: "Voir mes projets" },
  "hero.cta2": { en: "Get In Touch", fr: "Contactez-moi" },
  ...
  "journey.eyebrow": { en: "Modern Technology Stack", fr: "Mon parcours" },
  "journey.enter": { en: "Scroll to travel", fr: "Faites défiler pour avancer" },
  "journey.chapter": { en: "Chapter", fr: "Chapitre" },
  "journey.lede": {
    en: "Leveraging Python, Django, React, PostgreSQL, and REST APIs to create secure, responsive, and user-focused digital solutions.",
    fr: "Stack technologique moderne\nExploiter Python, Django, React, PostgreSQL et les API REST pour créer des solutions numériques sécurisées, réactives et axées sur l'utilisateur.",
  },

  /* ---------------- design stack ---------------- */
  "stack.eyebrow": { en: "Toolkit", fr: "Outils" },
  "stack.h2": { en: "My Tech", fr: "Ma stack" },
  "stack.h2Em": { en: "Stack.", fr: "technique." },
  "stack.lede": {
    en: "The tools I use to architect, develop, test, and ship — from the first line of code to production.",
    fr: "Les outils avec lesquels j'architecture, développe, teste et livre — de la première ligne de code à la production.",
  },
  ...
  "cert.brandRole": { en: "Software Developer", fr: "Développeur Logiciel" },
